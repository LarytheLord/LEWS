// src/data/detailedTrajectories.js
export const detailedTrajectories = {
  chickens: {
    technology: "Chicken industrial farming",
    description: "Industrial chicken farming - the baseline fully locked-in system",
    lockInDimensions: {
      "regulatoryCapture": {
        label: "Regulatory Capture",
        description: "How deeply embedded in policy and regulation"
      },
      "infrastructureHardening": {
        label: "Infrastructure Hardening",
        description: "Physical infrastructure purpose-built for the system"
      },
      "supplyChainStandardization": {
        label: "Supply Chain Standardization",
        description: "How standardized and optimized the supply chains are"
      },
      "corporateConsolidation": {
        label: "Corporate Consolidation",
        description: "Degree of corporate control and concentration"
      },
      "pathDependency": {
        label: "Path Dependency",
        description: "How interconnected and self-reinforcing the system is"
      },
      "aiAutomationEmbedding": {
        label: "AI/Automation Embedding",
        description: "Integration of modern technology into the system"
      },
      "internationalExpansion": {
        label: "International Expansion",
        description: "Global spread and harmonization of the system"
      },
      "slaughterInertia": {
        label: "Slaughter/Processing Inertia",
        description: "Sunk costs in processing infrastructure"
      },
      "breedingLockIn": {
        label: "Breeding/Genetics Lock-in",
        description: "Dependence on specialized genetic lines"
      }
    },
    trajectories: {
      "factoryFarming": {
  ...
  fish: {
    technology: "Fish industrial farming",
    description: "Industrial fish farming - the baseline for aquatic animal systems",
    lockInDimensions: {
      "regulatoryCapture": {
        label: "Regulatory Capture",
        description: "How deeply embedded in policy and regulation"
    ...
    trajectories: {
      "factoryFarming": {
        technology: "Factory farming – fish farming",
        description: "Industrial fish farming with cage systems and intensive production methods.",
        trajectory: [
          {
            "year": 1970,
            "score": 5,
            "stage": "Early Research",
            "milestone": "Early experiments with intensive fish farming in Norway and Chile, focusing on salmon.",
            "uncertainty": "high"
          },
          {
            "year": 1980,
            "score": 15,
            "stage": "Early Commercialization",
            "milestone": "First commercial fish farms established, primarily Atlantic salmon in Norway.",
            "uncertainty": "high"
          },
          {
            "year": 1990,
            "score": 30,
            "stage": "Scaling",
            "milestone": "Rapid expansion of salmon farming in Norway, Chile, and other regions.",
            "uncertainty": "medium"
          },
          {
            "year": 2000,
            "score": 55,
            "stage": "Infrastructure Building",
            "milestone": "Standardized sea cage systems, feed mills, and processing infrastructure established.",
            "uncertainty": "medium"
          },
          {
            "year": 2010,
            "score": 75,
            "stage": "Regulatory Capture",
            "milestone": "Industry standards and regulations favor intensive farming, large corporations dominate.",
            "uncertainty": "low"
          },
          {
            "year": 2020,
            "score": 88,
            "stage": "Locked In",
            "milestone": "Intensive fish farming is the dominant global model for aquatic animal protein.",
            "uncertainty": "low"
          }
        ]
      }
  ...
  insects: {
    technology: "Insect industrial farming",
    description: "Industrial insect farming - emerging technology with potential for high animal welfare",
    lockInDimensions: {
      "regulatoryCapture": {
        label: "Regulatory Capture",
        description: "How deeply embedded in policy and regulation"
  ...
  shrimp: {
    technology: "Shrimp industrial farming",
    description: "Industrial shrimp farming - intensive aquaculture with significant animal welfare concerns",
    lockInDimensions: {
      "regulatoryCapture": {
        label: "Regulatory Capture",
        description: "How deeply embedded in policy and regulation"
